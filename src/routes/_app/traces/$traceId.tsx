...
export const Route = createFileRoute("/_app/traces/$traceId")({
  validateSearch: (search: Record<string, unknown>): TraceDetailSearch => ({
    ...
    from: typeof search.from === "number" ? search.from : typeof search.from === "string" ? Number(search.from) || undefined : undefined,
    to: typeof search.to === "number" ? search.to : typeof search.to === "string" ? Number(search.to) || undefined : undefined,
  }),
});
