...
export const topicLagSchema = z.object({
  topic: stringValue,
  lag: numericValue,
  lead: numericValue,
}).strict();

export const topicConsumersSchema = z.object({
  topic: stringValue,
...
export const groupCommitsSchema = z.object({
  consumer_group: stringValue,
...
export const groupFetchesSchema = z.object({
  consumer_group: stringValue,
...
export const groupHealthSchema = z.object({
  consumer_group: stringValue,
...
export const topicGroupThroughputSchema = z.object({
  consumer_group: stringValue,
  bytes_per_sec: numericValue,
  records_per_sec: numericValue,
}).strict();

export const topicGroupLagSchema = z.object({
  consumer_group: stringValue,
  lag: numericValue,
  lead: numericValue,
}).strict();

export const groupTopicSchema = z.object({
  topic: stringValue,
  bytes_per_sec: numericValue,
  bytes_total: numericValue,
  records_per_sec: numericValue,
...
export const kafkaPartitionRowSchema = z.object({
  topic: stringValue,
...
export const kafkaSummarySchema = z.object({
...
export const kafkaTopicTrendPointSchema = z.object({
...
export const kafkaGroupTrendPointSchema = z.object({
  timestamp: stringValue,
  assigned_partitions: numericValue,
  commit_rate: numericValue,
  fetch_rate: numericValue,
