...
import { buildCumulativeSeries, parseBucketMs, prepareLogsTrendData } from "./logsTrendDataUtils";
...
describe("LogsTrendChart Data Utilities", () => {
  ...
  describe("prepareLogsTrendData & buildCumulativeSeries", () => {
    it("calculates stacked/cumulative series correctly (before/after equal test)", () => {
      ...
      const [timestamps, errSeries, warnSeries, infoSeries, debugSeries] =
        buildCumulativeSeries(buckets);
