...
export const aiConversationsApi = {
  async list(teamId: number | null, startTime: RequestTime, endTime: RequestTime, limit?: number): Promise<Conversation[]> {
  ...
  async get(teamId: number | null, conversationId: string, startTime: RequestTime, endTime: RequestTime): Promise<ConversationTurn[]> {
