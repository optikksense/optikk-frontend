...
export function TrendPanel({
  ...
  const toneClasses =
    tone === "errors"
      ? "border-[color-mix(in_oklch,var(--color-error),transparent_65%)] bg-[linear-gradient(180deg,rgba(240,68,56,0.07),rgba(240,68,56,0.02))]"
      : tone === "latency"
        ? "border-[color-mix(in_oklch,var(--color-warning),transparent_65%)] bg-[linear-gradient(180deg,rgba(245,158,11,0.07),rgba(245,158,11,0.02))]"
        : "border-[color-mix(in_oklch,var(--color-primary),transparent_65%)] bg-[linear-gradient(180deg,rgba(94,96,206,0.07),rgba(94,96,206,0.02))]";
