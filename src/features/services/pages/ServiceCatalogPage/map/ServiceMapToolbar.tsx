...
export function ServiceMapToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 border-[var(--border-color)] border-b px-4 py-3">
      <div className="flex flex-col gap-0.5">
        <div className="font-medium text-[13px] text-[var(--text-primary)]">Service map</div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="flex items-center gap-3">
          {LEGEND.map((item) => (
            <span key={item.label} className="flex items-center gap-1.5 text-[11px] text-[var(--text-muted)]">
              <span
        ...
        <select
          ...
          className="rounded-md border border-[var(--border-color)] bg-[var(--bg-card)] px-2.5 py-1 text-[12px] text-[var(--text-primary)] outline-none"
        >
          {services.map((name) => (
