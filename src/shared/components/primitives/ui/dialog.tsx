  ...
  return (
    ...
    >
      <DialogPrimitive.Portal>
        <DialogPrimitive.Overlay className="data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-[var(--bg-overlay)] backdrop-blur-sm data-[state=closed]:animate-out data-[state=open]:animate-in" />
