  ...
  return (
    ...
    >
      ...
      <div className="flex shrink-0 items-center justify-between border-[color:var(--glass-border)] border-b px-5 py-[14px]">
        ...
        <button
          type="button"
          className="flex cursor-pointer items-center rounded-md border-none bg-transparent p-2 text-muted-foreground transition-all duration-100 hover:bg-accent hover:text-white"
          onClick={onClose}
        >
          <X size={18} />
        </button>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-3">
        ...
        {tab === "json" && (
          <pre className="whitespace-pre-wrap break-all rounded-[7px] border border-border bg-accent p-3.5 font-mono text-[11.5px] text-foreground leading-[1.65]">
