  ...
  const BoardHeader = useMemo(
    () =>
      function BoardHeaderComponent() {
        return (
          <div
            className="sticky top-0 z-20 flex select-none border-[color:var(--glass-border)] border-b bg-[var(--bg-hover)] font-semibold text-[11px] text-muted-foreground uppercase tracking-[0.05em]"
        ...
        <Virtuoso
          ...
          itemContent={(index, row) => (
            <div
              ...
              className="flex cursor-pointer items-baseline border-[color:var(--glass-border)] border-b font-mono text-xs transition-colors duration-[80ms] ease-in-out hover:bg-[var(--bg-hover)]"
              style={{ minWidth: tableMinWidth, width: "max-content" }}
            >
