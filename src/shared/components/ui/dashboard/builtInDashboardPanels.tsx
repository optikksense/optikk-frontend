...
import {
  StatCardRenderer,
  StatSummaryRenderer,
} from './renderers/StatCardRenderer';
...
const RequestChart = lazy(() =>
  import('@shared/components/ui/charts/time-series/RequestChart').then((module) => ({ default: module.default })),
);
const ErrorRateChart = lazy(() =>
  import('@shared/components/ui/charts/time-series/ErrorRateChart').then((module) => ({ default: module.default })),
);
const ExceptionTypeLineChart = lazy(() =>
  import('@shared/components/ui/charts/time-series/ExceptionTypeLineChart').then((module) => ({ default: module.default })),
);
const LatencyChart = lazy(() =>
  import('@shared/components/ui/charts/time-series/LatencyChart').then((module) => ({ default: module.default })),
);
...
export const BUILT_IN_DASHBOARD_PANELS: readonly DashboardPanelRegistration[] = [
  ...
  { panelType: 'scorecard', kind: 'specialized', component: ScorecardRenderer },
