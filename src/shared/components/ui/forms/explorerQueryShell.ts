...
export const EXPLORER_QUERY_SURFACE_CLASSNAME = cn(
  ...
  "focus-within:border-[var(--color-primary)] focus-within:shadow-[0_0_0_1px_var(--color-primary)]"
);
...
export const EXPLORER_QUERY_DROPDOWN_CLASSNAME = cn(
  ...
  "border border-[var(--glass-border)] bg-[var(--bg-overlay)]",
...
export const EXPLORER_QUERY_POPOVER_CLASSNAME = cn(
  ...
  "bg-[var(--bg-overlay)] shadow-[var(--shadow-lg)] backdrop-blur-xl"
);
...
export const EXPLORER_QUERY_HINTS_CLASSNAME = cn(
  ...
  "bg-[var(--bg-overlay)] px-3.5 py-2.5 shadow-[var(--shadow-lg)] backdrop-blur-xl"
);
