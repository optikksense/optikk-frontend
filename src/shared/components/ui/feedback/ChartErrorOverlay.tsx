  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-3 px-4 py-6 text-center">
      ...
      <div className="flex flex-col gap-1.5">
        <span className="font-semibold text-error text-[13px]">{label}</span>
        <span className="max-w-[340px] text-foreground-secondary text-[12px] leading-relaxed">{message}</span>
        <span className="mt-1 inline-flex items-center justify-center self-center rounded bg-error-subtle px-2 py-0.5 font-mono text-error text-[10px] uppercase tracking-wider">
          {code}
        </span>
      </div>
    </div>
