...
export default function ChartNoDataOverlay() {
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-3 px-4 py-6 text-center">
      <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-warning-subtle)]">
        <AlertTriangle size={22} className="text-[var(--color-warning)]" />
      </div>
      <div className="flex flex-col gap-1">
        <span className="font-semibold text-[var(--color-warning)] text-[13px]">No data available</span>
        <span className="max-w-[280px] text-[var(--text-secondary)] text-[12px] leading-relaxed">
