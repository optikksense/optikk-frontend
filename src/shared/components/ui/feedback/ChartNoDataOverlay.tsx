  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-3 px-4 py-6 text-center">
      ...
      <div className="flex flex-col gap-1">
        <span className="font-semibold text-warning text-[13px]">No data available</span>
        <span className="max-w-[280px] text-foreground-secondary text-[12px] leading-relaxed">
