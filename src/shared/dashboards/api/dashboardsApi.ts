...
export async function getDashboardPage(id: number): Promise<DashboardPageDetail> {
  return api.get<DashboardPageDetail>(`${PAGES}/${id}`);
}
...
export async function createWidget(
  ...
  return api.post<Dashboard>(`${PAGES}/${pageId}/dashboards`, payload);
}
...
export async function updateWidget(
  ...
  return api.put<Dashboard>(`${PAGES}/${pageId}/dashboards/${widgetId}`, payload);
}
