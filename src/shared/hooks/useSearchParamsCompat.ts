import { useSearch, useNavigate, RouteComponent } from '@tanstack/react-router';
 ...
 */
export function useSearchParamsCompat(): [URLSearchParams, (newParams: URLSearchParams | ((prev: URLSearchParams) => URLSearchParams), options?: { replace?: boolean }) => void] {
  ...
  const setSearchParams = useCallback((newParams: URLSearchParams | ((prev: URLSearchParams) => URLSearchParams), options?: { replace?: boolean }) => {
