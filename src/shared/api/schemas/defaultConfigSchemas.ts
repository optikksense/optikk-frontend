...
export const pageSchema: z.ZodType<DefaultConfigPage> = z.object({
...
export const tabSummarySchema: z.ZodType<DefaultConfigTab> = z.object({
  id: z.string(),
  pageId: z.string(),
  label: z.string(),
  order: z.number(),
...
export const dashboardTabDocumentSchema: z.ZodType<DashboardTabDocument> = z.object({
  id: z.string(),
  pageId: z.string(),
  label: z.string(),
  order: z.number(),
