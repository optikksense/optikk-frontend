...
export const DEMO_LOG_ROWS: readonly DemoLogRow[] = [
  {
    ...
    message: "POST /checkout → 200 in 112ms trace_id=8f3c…",
  },
  {
    tsMs: NOW_MS - 8_000,
    level: "WARN",
    service: "search-api",
    message: "elasticsearch query exceeded 500ms budget (took 612ms)",
  },
  {
    tsMs: NOW_MS - 14_000,
    level: "ERROR",
    service: "payments-api",
    message: "stripe.charge failed: card_declined (customer=cus_MkJ…)",
  },
  {
    tsMs: NOW_MS - 22_000,
    level: "INFO",
    service: "catalog-api",
    message: "cache hit rate 94.2% over last 1m window",
  },
  {
    tsMs: NOW_MS - 31_000,
    level: "INFO",
    service: "notify-worker",
    message: "enqueued 48 email notifications (topic=order.placed)",
  },
  {
    tsMs: NOW_MS - 44_000,
    level: "ERROR",
    service: "checkout-api",
    message: "kafka publish timeout after 3 retries (topic=order.placed)",
  },
  {
    tsMs: NOW_MS - 58_000,
    level: "INFO",
    service: "payments-api",
    message: "refund processed amount=$89.00 order=ORD-1139",
  },
  {
    tsMs: NOW_MS - 72_000,
    level: "DEBUG",
    service: "search-api",
    message: "reindex batch=128 docs flushed in 94ms",
  },
] as const;
